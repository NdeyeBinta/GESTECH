            ...
            <div class="content_bg">
                <div class="mainbar">
                    <div class="article">
                        ...
                        <div class=class="col-md-8 col-xs-12 col-md-offset-2" style="margin-top:12px;">
                                ...
                                <div class="panel-body">
                                    <table class="table table-bordered table-stripped">
                                        <?php
                                            ...
                                            $list= listeDeclaration();
                                            while($row=mysqli_fetch_row($list))
                                            {
                                                echo"<tr>
                                                               <img src='../Controller/picture'.$row[7]. width='200px' height='100px'/></br></br>
                                                                $row[1]</br>
                                                                $row[2]</br>
                                                                $row[3]</br>
                                                                $row[4]</br>
                                                                $row[5]</br>
                                                                $row[6]</br>
                                                              <a href='../Controller/TrouverController.php?id=$row[0]' onclick='javascript:return confirmation();'> SUPPRIMER</a></br>
                                                         </tr>";
                                            }
                                        ?>
                                    </table>
